...
class TowerSystem{
public:
    void Update(float dt, GameData& gameData, ParticleSystem& particles, SoundSystem& sound);
...
private:
    ...
    void Fire(Tower& tower, const std::vector<DenseSlotMap<Enemy>::Key>& targetKeys, GameData& gameData, ParticleSystem& particles, SoundSystem& sound);
